...
$con_laboral = $_POST['cond_laboral'];
...
if ($c_r_b_docente == 0) {//validamos que no haya registros en la base de datos
	$insertar = "INSERT INTO docente (dni, apellidos_nombres,  fecha_nac, direccion, correo, telefono, id_genero, nivel_educacion, cond_laboral, id_cargo) VALUES ('$dni','$nom_ap', '$fecha_nac', '$direccion', '$email', '$cel','$id_genero', '$niv_edu','$con_laboral', '$id_cargo')";
