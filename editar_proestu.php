...
$busc_programa_estudios = buscarProgramaEstudio($conexion, $id_programa_estudios);
        ...
        <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left" method="POST" action="operaciones/actualizar_pro_estu.php">
