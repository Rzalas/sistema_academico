...
$id_nombre= $_GET['id'];
$busc_nombre= buscarPeriodoAcademicoByName($conexion, $id_nombre);
$res_b_periodo_academico= mysqli_fetch_array($busc_nombre);
        ...
        <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left" method="POST" action="operaciones/actualizar_periodo_acade.php">
                        <input type="hidden" name="id" value="<?php echo $id_nombre;?>">
                
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nombre :
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nombre" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $res_b_periodo_academico['nombre']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" name="fecha_ini" class="date-picker form-control col-md-7 col-xs-12" required="required"  value="<?php echo $res_b_periodo_academico['fecha_inicio']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" name="fecha_actas" class="date-picker form-control col-md-7 col-xs-12" required="required"  value="<?php echo $res_b_periodo_academico['fecha_actas']; ?>">
                        </div>
                      </div>
