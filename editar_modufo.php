...
$busc_modulos_formativos = buscarModuloProfesional($conexion, $id_modulos_formativos);
        ...
        <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left" method="POST" action="operaciones/actualizar_modufor.php">
                      ...
                      <div class="form-group">
                        ...
                        <select name="id_programa_estudio" id="id_prog_estudio" class="form-control col-md-7 col-xs-12" value="<?php echo $res_b_modulos_formativos['id_programa_estudio']; ?>">
                          ...
                          $buscar_prog_estudio = buscarProgramaEstudio($conexion);
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="modulo_formativo.php"><button class="btn btn-primary" type="button">Cancelar</button></a>
